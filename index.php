...
<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <a class="navbar-brand" href="#">
        <img src="images/pizza.png" alt="logo" class="d-inline-block align-text-top">
    </a>
...
<div class="container-fluid d-flex align-items-center" id="second-section">
    <div class="container">
        <div class="row">
            <div class="d-flex align-items-center justify-content-center">
                <img src="images/italian-cuisine.png" alt="">
            </div>
        </div>          
    </div>
</div>
